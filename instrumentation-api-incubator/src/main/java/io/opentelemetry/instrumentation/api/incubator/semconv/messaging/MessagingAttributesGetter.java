...
public interface MessagingAttributesGetter<REQUEST, RESPONSE> {
  ...
  @Nullable
  default Long getBatchMessageCount(REQUEST request, @Nullable RESPONSE response) {return null;}
  ...
  @Nullable
  default String getOperationName(REQUEST request) { return null; }
  ...
  @Nullable
  default String getConversationId(REQUEST request) {return null;}
